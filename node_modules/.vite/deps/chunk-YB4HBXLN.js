// node_modules/.pnpm/effector@22.8.0/node_modules/effector/effector.mjs
function e(e2, t2) {
  for (let r2 in e2)
    t2(e2[r2], r2);
}
...
function a({ node: e2 = [], from: r2, source: n2, parent: a2 = r2 || n2, to: i2, target: o2, child: l2 = i2 || o2, scope: s2 = {}, meta: f2 = {}, family: u2 = { type: "regular" }, regional: d2 } = {}) {
  ...
  return t(p2, (e3) => le(T(e3), h2)), t(m2, (e3) => le(B(e3), h2)), t(c2, (e3) => le(e3.next, h2)), d2 && he && we(H(he), [h2]), h2;
}
function i(e2, r2, n2) {
  ...
  if (e2.target && (r2 = e2.params, n2 = e2.defer, a2 = e2.meta, i2 = "page" in e2 ? e2.page : i2, e2.stack && (o2 = e2.stack), l2 = G(e2) || l2, e2 = e2.target), l2 && et && l2 !== et && (et = null), Array.isArray(e2))
    for (let t2 = 0; t2 < e2.length; t2++)
      Qe("pure", i2, L(e2[t2]), o2, r2[t2], l2, a2);
  else
    Qe("pure", i2, L(e2), o2, r2, l2, a2);
  if (n2 && !tt)
    return;
...
function d(e2, t2) {
  let r2 = gt({ or: t2, and: "string" == typeof e2 ? { name: e2 } : e2 }), n2 = (e3, ...t3) => (se(!J(n2, "derived"), "call of derived event", "createEvent"), se(!nt, "unit call from pure function", "operators like sample"), at ? ((e4, t4, r3, n3) => {
    ...
    return lt(a2), o3;
  })(n2, o2, e3, t3) : n2.create(e3, t3)), o2 = ve(), l2 = Object.assign(n2, { graphite: a({ meta: zt(r2.actualOp || "event", n2, r2), regional: 1 }), create: (e3) => (i({ target: n2, params: e3, scope: et }), e3), watch: (e3) => Mt(n2, e3), map: (e3) => $t(n2, P, e3, [Le()]), filter: (e3) => $t(n2, "filter", e3.fn ? e3 : e3.fn, [Le(Ie, 1)]), filterMap: (e3) => $t(n2, "filterMap", e3, [Le(), Pe((e4) => !ze(e4), 1)]), prepend(e3) {
    let t3 = d("* → " + n2.shortName, { parent: V(n2) });
    return u("eventPrepend", L(t3)), wt(t3, n2, [Le()], "prepend", e3), xt(n2, t3), t3;
  } });
  return null != r2 && r2.domain && r2.domain.hooks.event(l2), ye(l2.graphite), l2;
}
function c(e2, n2, a2, i2) {
  return Ce(a2, n2, "first argument"), r(xe(i2), "second argument should be a function"), se(!J(e2, "derived"), `${n2} in derived store`, `${n2} in store created via createStore`), t(Array.isArray(a2) ? a2 : [a2], (t2) => {
    e2.off(t2), U(e2).set(t2, kt(jt(t2, e2, "on", qe, i2)));
  }), e2;
}
function p(e2, n2) {
  let o2 = gt(n2), l2 = Be(e2), s2 = d({ named: "updates", derived: 1 });
  u("storeBase", l2);
  let f2 = l2.id, m2 = { subscribers: /* @__PURE__ */ new Map(), updates: s2, defaultState: e2, stateRef: l2, getState() {
    ...
    let r2, n3;
    Me(e3) && (r2 = e3, e3 = e3.fn), se(ze(t2), "second argument of store.map", "updateFilter");
    let a2 = m2.getState();
    ve() ? n3 = null : ze(a2) || (n3 = e3(a2, t2));
    let i2 = p(n3, { name: `${m2.shortName} → *`, derived: 1, and: r2 }), o3 = jt(m2, i2, P, Oe, e3);
    return He(W(i2), { type: P, fn: e3, from: l2 }), W(i2).noInit = 1, u("storeMap", l2, o3), i2;
  }, watch(e3, t2) {
    if (!t2 || !X(e3)) {
      let t3 = Mt(m2, e3);
  ...
  } }, g2 = zt("store", m2, o2), h2 = m2.defaultConfig.updateFilter;
  m2.graphite = a({ scope: { state: l2, fn: h2 }, node: [Pe((e3, t2, r2) => (r2.scope && !r2.scope.reg[l2.id] && (r2.b = 1), e3)), _e(l2), Pe((e3, t2, { a: r2, b: n3 }) => !ze(e3) && (e3 !== r2 || n3), 1), h2 && Le(Oe, 1), Re({ from: _, target: l2 })], child: s2, meta: { ...g2, defaultState: e2 }, regional: 1 });
  let y2 = J(m2, "serialize"), v2 = J(m2, "derived"), b2 = "ignore" === y2, k2 = !y2 || b2 ? 0 : y2, w2 = J(m2, "sid");
  return w2 && (K(m2, "storeChange", 1), l2.sid = w2, k2 && (l2.meta = { ...null == l2 ? void 0 : l2.meta, serialize: k2 })), w2 || b2 || v2 || K(m2, "warnSerialize", 1), r(v2 || !ze(e2), "current state can't be undefined, use null instead"), we(m2, [s2]), null != o2 && o2.domain && o2.domain.hooks.store(m2), v2 || (m2.reinit = d({ named: "reinit" }), m2.reset(m2.reinit)), ye(m2.graphite), m2;
}
function m(...e2) {
  let t2, n2, a2;
  [e2, a2] = f(e2);
  let i2, o2, l2, s2 = e2[e2.length - 1];
  if (xe(s2) ? (n2 = e2.slice(0, -1), t2 = s2) : n2 = e2, 1 === n2.length) {
    let e3 = n2[0];
    Z(e3) || (i2 = e3, o2 = 1);
  }
  if (!o2 && (i2 = n2, t2)) {
  ...
  return r(Me(i2), "shape should be an object"), Ct(Array.isArray(i2), !l2, i2, a2, t2);
}
function g(...e2) {
...
function y(e2, t2 = {}) {
  let n2 = gt(xe(e2) ? { handler: e2 } : e2, t2), o2 = d(xe(e2) ? { handler: e2 } : e2, { ...t2, actualOp: "effect" }), l2 = L(o2);
  ...
  } }), c2 = o2.doneData = f2.map({ named: "doneData", fn: ({ result: e3 }) => e3 }), m2 = o2.failData = u2.map({ named: "failData", fn: ({ error: e3 }) => e3 }), g2 = a({ scope: { handler: o2.defaultConfig.handler || (() => r(0, `no handler used in ${o2.getType()}`)) }, node: [Pe((e3, t3, r2) => {
    let n3 = t3.handler, a2 = G(r2);
    if (a2) {
      let e4 = o2.sid ? a2.handlers.sidMap[o2.sid] : a2.handlers.unitMap.get(o2);
      e4 && (n3 = e4);
    }
    return e3.handler = n3, e3;
  }, 0, 1), Pe(({ params: e3, req: t3, handler: r2, args: n3 = [e3] }, a2, i2) => {
    let o3 = Ot(i2), l3 = qt(e3, t3, 1, s2, i2, o3), f3 = qt(e3, t3, 0, s2, i2, o3), [u3, d2] = At(r2, f3, n3);
    u3 && (Me(d2) && xe(d2.then) ? d2.then(l3, f3) : l3(d2));
  }, 0, 1)], meta: { op: "fx", fx: "runner" } });
  l2.scope.runner = g2, le(l2.seq, Pe((e3, { runner: t3 }, r2) => {
    let n3 = V(r2) ? { params: e3, req: { rs(e4) {
    }, rj(e4) {
    } } } : e3;
  ...
  return we(o2, [s2, f2, u2, c2, m2, v2, y2]), null != n2 && n2.domain && n2.domain.hooks.effect(o2), o2;
}
function v(e2) {
  let t2;
  [e2, t2] = f(e2, 1);
  ...
  K(o2, "attached", 1);
  let l2, { runner: u2 } = L(o2).scope, d2 = Pe((e3, t3, n3) => {
    let l3, { params: s2, req: f2, handler: u3 } = e3, d3 = o2.finally, c3 = Ot(n3), p2 = qt(s2, f2, 0, d3, n3, c3), m2 = n3.a, g2 = te(u3), h2 = 1;
    if (a2 ? [h2, l3] = At(a2, p2, [s2, m2]) : l3 = r2 && g2 ? m2 : s2, h2) {
      if (!g2)
        return e3.args = [m2, l3], 1;
      i({ target: u3, params: { params: l3, req: { rs: qt(s2, f2, 1, d3, n3, c3), rj: p2 } }, page: n3.page, defer: 1, meta: n3.meta });
    }
  }, 1, 1);
  if (r2) {
    let e3;
    Z(r2) ? (e3 = r2, we(e3, [o2])) : (e3 = m(r2), we(o2, [e3])), l2 = [_e(W(e3)), d2];
  } else
    l2 = [d2];
  u2.seq.splice(1, 0, ...l2), o2.use(n2);
  let c2 = V(n2);
  return c2 && (Object.assign(Q(o2), s(o2.shortName, c2)), o2.defaultConfig.parent = c2), xt(n2, o2, "effect"), o2;
}
function b(...t2) {
  let [[r2, n2], a2] = f(t2), i2 = {};
  return e(n2, (e2, t3) => {
    let n3 = i2[t3] = d(t3, { parent: V(r2), config: a2 });
    r2.on(n3, e2), xt(r2, n3);
  }), i2;
}
function k(r2, n2) {
  ...
  l2.meta = zt("domain", s2, { parent: (null == o2 ? void 0 : o2.domain) || (null == o2 ? void 0 : o2.parent), or: o2 }), e({ Event: d, Effect: y, Store: p, Domain: k }, (e2, r3) => {
    let n3 = r3.toLowerCase(), a2 = d({ named: `on${r3}` });
    s2.hooks[n3] = a2;
    let o3 = /* @__PURE__ */ new Set();
    s2.history[`${n3}s`] = o3, a2.create = (e3) => (i(a2, e3), e3), le(L(a2).seq, Pe((e3, t2, r4) => (r4.scope = null, e3))), a2.watch((e3) => {
...
function x(...e2) {
  ...
  return ze(o2) && Me(i2) && M(i2, "sample") && (o2 = i2.clock, l2 = i2.fn, u2 = !i2.greedy, a2 = i2.filter, t2 = i2.target, r2 = i2.name, n2 = i2.sid, i2 = i2.source), Rt("sample", o2, i2, a2, t2, l2, r2, s2, u2, 1, 0, n2);
}
function z(...e2) {
  let [[t2, r2], n2] = f(e2);
  return r2 || (r2 = t2, t2 = r2.source), M(r2, "guard"), Rt("guard", r2.clock, t2, r2.filter, r2.target, null, r2.name, n2, !r2.greedy, 0, 1);
}
function $(t2, r2, n2) {
  if (Z(t2))
    return se(0, "restore($store)"), t2;
  if (ee(t2) || te(t2)) {
    let e2 = V(t2), a3 = p(r2, { parent: e2, name: t2.shortName, and: n2 });
...
function j(...t2) {
  ...
  let y2, v2 = new Set([].concat(l2, i2 || [], Object.values(n2))), b2 = Object.keys(m2 || g2 ? n2 : s2);
  if (m2 || g2)
    m2 && v2.add(s2), y2 = [m2 && _e(W(s2), 0, 1), De({ safe: m2, filter: 1, pure: !m2, fn(e2, t3, r2) {
      let n3 = String(m2 ? r2.a : s2(e2));
      Pt(t3, ie(b2, n3) ? n3 : "__", e2, r2);
    } })];
  else if (h2) {
    let t3 = Be({});
    t3.type = "shape";
    ...
    e(s2, (e2, a2) => {
      if (X(e2)) {
        r2 = 1, le(n3, a2), v2.add(e2);
        let i3 = wt(e2, [], [_e(t3), Pe((e3, t4, { a: r3 }) => r3[a2] = e3)]);
        if (Z(e2)) {
          t3.current[a2] = e2.getState();
          let r3 = W(e2);
          He(t3, { from: r3, field: a2, type: "field" }), u("splitMatchStore", r3, i3);
        }
      }
    }), r2 && u("splitBase", t3), y2 = [r2 && _e(t3, 0, 1), Le((e2, t4, r3) => {
  ...
  let k2 = a({ meta: { op: o2 }, parent: i2 ? [] : l2, scope: n2, node: y2, family: { owners: Array.from(v2) }, regional: 1 });
...
function A(e2, r2, n2) {
  let a2 = [];
  (function e3(i2) {
    ie(a2, i2) || (le(a2, i2), "store" === J(i2, "op") && (n2 || J(i2, "sid")) && r2(i2, J(i2, "sid")), t(i2.next, e3), t(T(i2), e3), t(B(i2), e3));
  })(e2);
}
function O(e2, n2) {
  let a2 = Array.isArray(e2) ? new Map(e2) : e2, i2 = /* @__PURE__ */ new Map();
  if (a2 instanceof Map) {
    let e3 = {};
    return t(a2, (t2, a3) => {
      r(X(a3), "Map key should be a unit"), n2 && n2(a3, t2), a3.sid ? (r(!(a3.sid in e3), "duplicate sid found"), e3[a3.sid] = t2) : i2.set(a3, t2);
...
function q(e2, n2) {
  ...
  let l2 = ((e3) => {
    let r2 = a({ scope: { defers: [], inFlight: 0, fxID: 0 }, node: [Pe((e4, t2, r3) => {
    ...
    }), De({ priority: "sampler", batch: 1 }), Pe((e4, r3) => {
      ...
      if (n4) {
        let t3 = n4.node;
        if (!J(t3, "isCombine") || V(n4) && "combine" !== J(V(n4).node, "op")) {
          let n5 = G(r3), a2 = t3.scope.state.id, i4 = J(t3, "sid");
          n5.sidIdMap[i4] = a2, n5.values.sidMap[i4] = e4;
      ...
      if (n4) {
        let e5 = V(r3);
        e5 && (!J(e5.node, "isCombine") || V(e5) && "combine" !== J(V(e5).node, "op")) && (n4.warnSerialize = 1);
      }
    ...
    }, kind: "scope", graphite: a({ family: { type: "domain", links: [r2, n3, i3] }, meta: { unit: "fork" }, scope: { forkInFlightCounter: r2 } }), additionalLinks: {}, handlers: { sidMap: {}, unitMap: /* @__PURE__ */ new Map() }, fxCount: r2, storeChange: n3, warnSerializeNode: i3, activeEffects: [] };
    return o3;
  })(i2);
  if (o2) {
    let e3 = o2.scope;
    ...
    if (o2.values) {
      let { sidMap: e4, unitMap: n3 } = O(o2.values, (e5) => r(Z(e5), "Values map can contain only stores as keys"));
      Object.assign(l2.values.sidMap, e4), t(n3, (e5, t2) => {
        l2.values.idMap[t2.stateRef.id] = e5;
      }), l2.fromSerialize = !(Array.isArray(o2.values) || o2.values instanceof Map);
    }
    o2.handlers && (l2.handlers = O(o2.handlers, (e4) => r(te(e4), "Handlers map can contain only effects as keys")));
  }
  return l2;
}
function I(e2, { values: n2 }) {
  r(Me(n2), "values property should be an object");
  let { sidMap: a2, unitMap: o2 } = O(n2), l2 = Object.getOwnPropertyNames(a2), s2 = {};
  t(o2, (e3, t2) => {
    s2[t2.stateRef.id] = t2;
  });
  let f2, u2, d2, c2 = [], p2 = [];
  ne(e2) ? (f2 = e2, d2 = 1, r(f2.cloneOf, "scope should be created from domain"), u2 = L(f2.cloneOf)) : re(e2) ? u2 = L(e2) : r(0, "first argument of hydrate should be domain or scope"), A(u2, (e3, t2) => {
    if (t2 && ie(l2, t2)) {
      le(c2, e3);
      let r2 = J(e3, "serialize");
      r2 && "ignore" !== r2 && (a2[t2] = r2.read(a2[t2])), le(p2, a2[t2]);
    } else
      e3.scope.state.id in s2 && (le(c2, e3), le(p2, o2.get(s2[e3.scope.state.id])));
  }, 1), i({ target: c2, params: p2, scope: f2 }), d2 && Object.assign(f2.values.sidMap, a2);
}
...
function F(t2, n2 = {}) {
  ...
  return e(t2.values.sidMap, (e2, r2) => {
    ...
    if (ie(a2, r2))
      return;
    let o2 = t2.sidIdMap[r2], l2 = null !== (n3 = t2.sidSerializeSettings.get(r2)) && void 0 !== n3 ? n3 : { ignore: 0, write: Lt };
    l2.ignore || (i2[r2] = (0, l2.write)(o2 && o2 in t2.reg ? t2.reg[o2].current : e2));
  }), "onlyChanges" in n2 && !n2.onlyChanges && (r(t2.cloneOf, "scope should be created from domain"), A(L(t2.cloneOf), (e2, r2) => {
    r2 in i2 || ie(a2, r2) || J(e2, "isCombine") || "ignore" === J(e2, "serialize") || (i2[r2] = t2.getState(e2));
  })), i2;
}
function R({ unit: e2, fn: t2, scope: r2 }) {
  let n2 = [Te.run({ fn: (e3) => t2(e3) })];
  if (r2) {
...
var ke = ({ sid: e2, name: t2, loc: r2, method: i2, fn: o2 }) => n(a({ meta: { sidRoot: be(e2), sid: e2, name: t2, loc: r2, method: i2, type: "factory" } }), o2);
var we = (e2, r2) => {
  let n2 = L(e2);
  t(r2, (e3) => {
    let t2 = L(e3);
    "domain" !== n2.family.type && (t2.family.type = "crosslink"), le(T(t2), n2), le(B(n2), t2);
  });
};
...
var ze = (e2) => void 0 === e2;
var $e = (e2) => r(Me(e2) || xe(e2), "expect first argument be an object");
...
var Oe = (e2, { fn: t2 }, { a: r2 }) => t2(e2, r2);
var qe = (e2, { fn: t2 }, { a: r2 }) => t2(r2, e2);
var Ie = (e2, { fn: t2 }) => t2(e2);
var Ne = (e2, t2, r2, n2) => {
  let a2 = { id: ce(), type: e2, data: t2 };
  return r2 && (a2.order = { priority: r2 }, n2 && (a2.order.barrierID = ++Fe)), a2;
};
var Fe = 0;
var Re = ({ from: e2 = "store", store: t2, target: r2, to: n2 = r2 ? "store" : _, batch: a2, priority: i2 }) => Ne("mov", { from: e2, store: t2, to: n2, target: r2 }, i2, a2);
var De = ({ fn: e2, batch: t2, priority: r2, safe: n2 = 0, filter: a2 = 0, pure: i2 = 0 }) => Ne("compute", { fn: e2, safe: n2, filter: a2, pure: i2 }, r2, t2);
var Ee = ({ fn: e2 }) => De({ fn: e2, priority: "effect" });
var Pe = (e2, t2, r2) => De({ fn: e2, safe: 1, filter: t2, priority: r2 && "effect" });
var _e = (e2, t2, r2) => Re({ store: e2, to: t2 ? _ : "a", priority: r2 && "sampler", batch: 1 });
var Le = (e2 = Ie, t2) => De({ fn: e2, pure: 1, filter: t2 });
...
var Xe = (e2, t2, r2, n2 = 0) => {
  ...
  3 === a2 || 4 === a2 ? Ue = Ve(Ue, o2) : (0 === i2.size ? i2.first = o2 : i2.last.r = o2, i2.last = o2), i2.size += 1;
};
var Ye = (e2) => {
  switch (e2) {
    case "child":
...
var pt = (e2, r2, n2, a2, i2) => {
  ...
  if (s2 && s2 in e2.values.sidMap && !(s2 in e2.sidIdMap))
    u2.current = (e2.fromSerialize && "ignore" !== f2 && (null == f2 ? void 0 : f2.read) || ct)(e2.values.sidMap[s2]);
  else if (u2.id in e2.values.idMap)
...
var St = (e2) => {
  ...
  return Ce(r2, t2, '"from"'), Ce(n2, t2, '"to"'), Ae(t2, n2, "to"), kt(a({ parent: r2, child: n2, meta: { op: t2, config: i2 }, family: {}, regional: 1 }));
};
var Mt = (e2, t2) => (r(xe(t2), ".watch argument should be a function"), kt(a({ scope: { fn: t2 }, node: [Ee({ fn: Ie })], parent: e2, meta: { op: "watch" }, family: { owners: e2 }, regional: 1 })));
var xt = (e2, t2, r2 = "event") => {
  V(e2) && V(e2).hooks[r2](t2);
};
var zt = (e2, t2, r2) => {
  let n2 = gt(r2), a2 = "domain" === e2, i2 = de(), { sid: o2 = null, named: l2 = null, domain: f2 = null, parent: u2 = f2 } = n2, d2 = l2 || n2.name || (a2 ? "" : i2), c2 = s(d2, u2), p2 = { op: t2.kind = e2, name: t2.shortName = d2, sid: t2.sid = be(o2), named: l2, unitId: t2.id = i2, serialize: n2.serialize, derived: n2.derived, config: n2 };
  if (t2.parent = u2, t2.compositeName = c2, t2.defaultConfig = n2, t2.thru = (e3) => (se(0, "thru", "js pipe"), e3(t2)), t2.getType = () => c2.fullName, !a2) {
    t2.subscribe = (e4) => ($e(e4), t2.watch(xe(e4) ? e4 : (t3) => e4.next && e4.next(t3))), t2[E] = () => t2;
    let e3 = ve();
...
var jt = (e2, t2, r2, n2, a2) => {
  ...
  let l2 = [o2, Le(n2)];
  return u("storeOnMap", i2, l2, Z(e2) && W(e2)), wt(e2, t2, l2, r2, a2);
};
var Ct = (t2, n2, a2, i2, l2) => {
  let s2 = t2 ? (e2) => [...e2] : (e2) => ({ ...e2 }), f2 = t2 ? [] : {}, d2 = s2(f2), c2 = Be(d2), m2 = Be(1);
  c2.type = t2 ? "list" : "shape", c2.noInit = 1, u("combineBase", c2, m2);
  let g2 = p(d2, { name: o(a2), derived: 1, and: i2 }), h2 = W(g2);
  h2.noInit = 1, K(g2, "isCombine", 1);
  let y2 = _e(c2);
  y2.order = { priority: "barrier" };
  let v2 = [Pe((e2, t3, r2) => (r2.scope && !r2.scope.reg[c2.id] && (r2.c = 1), e2)), y2, Re({ store: m2, to: "b" }), Pe((e2, { key: t3 }, r2) => {
    if (r2.c || e2 !== r2.a[t3])
      return n2 && r2.b && (r2.a = s2(r2.a)), r2.a[t3] = e2, 1;
  }, 1), Re({ from: "a", target: c2 }), Re({ from: "value", store: 0, target: m2 }), Re({ from: "value", store: 1, target: m2, priority: "barrier", batch: 1 }), _e(c2, 1), l2 && Le()];
  return e(a2, (e2, t3) => {
    if (!Z(e2))
      return r(!X(e2) && !ze(e2), `combine expects a store in a field ${t3}`), void (d2[t3] = f2[t3] = e2);
    f2[t3] = e2.defaultState, d2[t3] = e2.getState();
    let n3 = wt(e2, g2, v2, "combine", l2);
    n3.scope.key = t3;
    let a3 = W(e2);
    He(c2, { type: "field", field: t3, from: a3 }), u("combineField", a3, n3);
  }), g2.defaultShape = a2, He(h2, { type: P, from: c2, fn: l2 }), ve() || (g2.defaultState = l2 ? h2.current = l2(d2) : f2), g2;
};
var At = (e2, t2, r2) => {
  try {
    return [1, e2(...r2)];
...
var qt = (e2, t2, r2, n2, a2, o2) => (l2) => {
  o2.ref && oe(o2.ref.activeEffects, o2), i({ target: [n2, It], params: [r2 ? { status: "done", params: e2, result: l2 } : { status: "fail", params: e2, error: l2 }, { value: l2, fn: r2 ? t2.rs : t2.rj }], defer: 1, page: a2.page, scope: o2.ref, meta: a2.meta });
};
var It = a({ node: [Ee({ fn: ({ fn: e2, value: t2 }) => e2(t2) })], meta: { op: "fx", fx: "sidechain" } });
var Nt = ["source", "clock", "target"];
var Ft = (e2, t2) => e2 + `: ${t2} should be defined`;
var Rt = (e2, t2, n2, a2, i2, o2, l2, s2, f2, c2, g2, h2) => {
  let y2 = !!i2;
  r(!ze(n2) || !ze(t2), Ft(e2, "either source or clock"));
  let v2 = 0;
  ze(n2) ? v2 = 1 : X(n2) || (n2 = m(n2)), ze(t2) ? t2 = n2 : (Ce(t2, e2, "clock"), Array.isArray(t2) && (t2 = S(t2))), v2 && (n2 = t2), s2 || l2 || (l2 = n2.shortName);
  let b2 = "none";
  (g2 || a2) && (X(a2) ? b2 = "unit" : (r(xe(a2), "`filter` should be function or unit"), b2 = "fn")), i2 ? (Ce(i2, e2, "target"), Ae(e2, i2)) : "none" === b2 && c2 && Z(n2) && Z(t2) ? i2 = p(o2 ? o2(We(W(n2)), We(W(t2))) : We(W(n2)), { name: l2, sid: h2, or: s2 }) : (i2 = d({ name: l2, derived: 1, or: s2 }), u("sampleTarget", L(i2)));
  let k2 = Be(), w2 = [];
  if ("unit" === b2) {
    let [r2, n3] = Et(a2, i2, t2, k2, e2);
    w2 = [...Dt(n3), ...Dt(r2)];
  }
  let [M2, x2] = Et(n2, i2, t2, k2, e2), z2 = wt(t2, i2, [u("sampleSourceLoader"), Re({ from: _, target: k2 }), ...Dt(x2), _e(M2, 1, f2), ...w2, _e(k2), "fn" === b2 && Le((e3, t3, { a: r2 }) => a2(e3, r2), 1), o2 && Le(Oe), u("sampleSourceUpward", y2)], e2, o2);
  return we(n2, [z2]), Object.assign(z2.meta, s2, { joint: 1 }), i2;
};
var Dt = (e2) => [_e(e2), Pe((e3, t2, { a: r2 }) => r2, 1)];
var Et = (e2, t2, r2, n2, i2) => {
  let o2 = Z(e2), l2 = o2 ? W(e2) : Be(), s2 = Be(o2);
  return o2 || a({ parent: e2, node: [Re({ from: _, target: l2 }), Re({ from: "value", store: 1, target: s2 })], family: { owners: [e2, t2, r2], links: t2 }, meta: { op: i2 }, regional: 1 }), u("sampleSource", s2, l2, n2), [l2, s2];
};
var Pt = (e2, t2, r2, n2) => {
  let a2 = e2[t2];
...
//# sourceMappingURL=chunk-YB4HBXLN.js.map
